 ...
 */
class AttachmentRestTest extends TestCase
{
    ...
    public function gettingModelSchema()
    {
        ...
        // login
        $response = $client->get('/jms/attachments/schema');
    ...
    public function gettingListOfAllArtifacts()
    {
        ...
        $response = $client->get('/jms/attachments');
        $this->assertResponseNotNull($response, 'Find result is empty');
        $this->assertResponseStatusCode($response, 200, 'Find status code is not 200');
    ...
    public function gettingNonEmptyArtifacts()
    {
        ...
        $attach = new Pluf\Jms\Attachment();
        $attach->job_id = $job;
        $attach->extract = false;
        $attach->file_name = 'hi.txt';
        $attach->file_path = __DIR__ . '/data/hi.txt';
        $attach->create();
